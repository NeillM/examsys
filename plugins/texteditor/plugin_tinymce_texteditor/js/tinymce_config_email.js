requirejs(['tinyMCE', 'rogoconfig', 'jquery'], function (Tinymce, config, $) {
  Tinymce.init({
    ...
    plugins: "visualchars nonbreaking paste lists code table template",
    ...
    menubar: false,
    statusbar: false,
    toolbar: "template | cut copy paste | undo | bold italic underline | subscript superscript | alignleft aligncenter alignright | numlist bullist | table | code |",
