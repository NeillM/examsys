...
<?php
  ...
  $module_details = module_utils::get_full_details_by_ID($_GET['teamID'], $mysqli);
  ?>
  <input type="hidden" name="screen" value="1" />
  <table class="header" cellspacing="0" cellpadding="0">
  <?php
  echo "<tr><th colspan=\"5\" style=\"font-size:160%\"><strong>&nbsp;" . $module_details['moduleid'] . ":</strong> " . $module_details['fullname'] . "</th></tr>\n";
  if ($order == 'leadin' and $direction == 'asc') {
    echo "<tr><th colspan=\"2\">&nbsp;</th><th class=\"vert_div\">&nbsp;<a href=\"" . $_SERVER['PHP_SELF'] . "?module=$module&folder=$folder&scrOfY=$scrOfY&order=leadin&direction=desc\">" . $string['question'] . "</a>&nbsp;<img src=\"../../artwork/desc.gif\" width=\"9\" height=\"7\" border=\"0\" /></th><th class=\"vert_div\">&nbsp;<a href=\"" . $_SERVER['PHP_SELF'] . "?module=$module&folder=$folder&scrOfY=$scrOfY&order=q_type&direction=asc\">" . $string['type'] . "</a>&nbsp;</th><th class=\"vert_div\"><nobr>&nbsp;<a href=\"" . $_SERVER['PHP_SELF'] . "?module=$module&folder=$folder&scrOfY=$scrOfY&order=last_edited&direction=asc\">" . $string['modified'] . "</a>&nbsp;</nobr></th></tr>\n";
  } elseif ($order == 'leadin' and $direction == 'desc') {
    echo "<tr><th colspan=\"2\">&nbsp;</th><th class=\"vert_div\">&nbsp;<a href=\"" . $_SERVER['PHP_SELF'] . "?module=$module&folder=$folder&scrOfY=$scrOfY&order=leadin&direction=asc\">" . $string['question'] . "</a>&nbsp;<img src=\"../../artwork/asc.gif\" width=\"9\" height=\"7\" border=\"0\" /></th><th class=\"vert_div\">&nbsp;<a href=\"" . $_SERVER['PHP_SELF'] . "?module=$module&folder=$folder&scrOfY=$scrOfY&order=q_type&direction=asc\">" . $string['type'] . "</a>&nbsp;</th><th class=\"vert_div\">&nbsp;<a href=\"" . $_SERVER['PHP_SELF'] . "?module=$module&folder=$folder&scrOfY=$scrOfY&order=last_edited&direction=asc\">" . $string['modified'] . "</a>&nbsp;</th></tr>\n";
  } elseif ($order == 'q_type' and $direction == 'asc') {
    echo "<tr><th colspan=\"2\">&nbsp;</th><th class=\"vert_div\">&nbsp;<a href=\"" . $_SERVER['PHP_SELF'] . "?module=$module&folder=$folder&scrOfY=$scrOfY&order=leadin&direction=asc\">" . $string['question'] . "</a>&nbsp;</th><th class=\"vert_div\">&nbsp;<a href=\"" . $_SERVER['PHP_SELF'] . "?module=$module&folder=$folder&scrOfY=$scrOfY&order=q_type&direction=desc\">" . $string['type'] . "</a>&nbsp;<img src=\"../../artwork/desc.gif\" width=\"9\" height=\"7\" border=\"0\" /></th><th class=\"vert_div\">&nbsp;<a href=\"" . $_SERVER['PHP_SELF'] . "?module=$module&folder=$folder&scrOfY=$scrOfY&order=last_edited&direction=asc\">" . $string['modified'] . "</a>&nbsp;</th></tr>\n";
  } elseif ($order == 'q_type' and $direction == 'desc') {
    echo "<tr><th colspan=\"2\">&nbsp;</th><th class=\"vert_div\">&nbsp;<a href=\"" . $_SERVER['PHP_SELF'] . "?module=$module&folder=$folder&scrOfY=$scrOfY&order=leadin&direction=asc\">" . $string['question'] . "</a>&nbsp;</th><th class=\"vert_div\">&nbsp;<a href=\"" . $_SERVER['PHP_SELF'] . "?module=$module&folder=$folder&scrOfY=$scrOfY&order=q_type&direction=asc\">" . $string['type'] . "</a>&nbsp;<img src=\"../../artwork/asc.gif\" width=\"9\" height=\"7\" border=\"0\" /></th><th class=\"vert_div\">&nbsp;<a href=\"" . $_SERVER['PHP_SELF'] . "?module=$module&folder=$folder&scrOfY=$scrOfY&order=last_edited&direction=asc\">" . $string['modified'] . "</a>&nbsp;</th></tr>\n";
