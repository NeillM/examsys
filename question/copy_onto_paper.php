  ...
  <table cellpadding="0" cellspacing="1" border="0" width="95%">
    ...
    while ($result->fetch()) {
        if (($paper_type == '2' or $paper_type == '4') and !is_null($start_date) and $current_time > $start_date) {
            ...
            echo '<tr><td style="width:16px"><img src="../artwork/small_yellow_warning_icon.gif" width="12" height="11" alt="' . $string['warning'] . "\" /></td><td><input type=\"radio\" name=\"property_id\" value=\"$paper_title\" disabled id=\"$property_id\" ><label for=\"$property_id\" style=\"color:#808080\">$paper_title</label></td></tr>\n";
        } else {
