...
$end_date = $properties->get_end_date();
...
<head>
    ...
    <title><?php echo page::title('ExamSys: ' . $string['hofstee']); ?></title>
...
if (isset($_GET['folder']) and $_GET['folder'] != '') {
  ...
  echo '<a href="../paper/details.php?paperID=' . $_GET['paperID'] . '">' . $properties->get_paper_title() . '</a><a href="index.php?paperID=' . $paperID . '&module=&folder=">' . $string['standardssetting'] . '</a></div>';
