...
Feature: Paper properties: Summative Exam (Summative management: on) (Admin)
  In order to schedule summative exams when summative management is enabled
  ...
  Background:
    ...
    And the following "faculties" exist:
      | code | name |
      | MHS | Faculty of Medicine and Health |
    And the following "schools" exist:
      | faculty | code | name |
      | MHS | MED | School of Medicine |
    And the following "modules" exist:
      | moduleid | fullname | school |
      | TEST1001 | Test module | MED |
      | TEST1002 | Another test module | MED |
    And the following "users" exist:
      ...
      | schooladmin | Staff, Admin | Peter | Mansfield | Prof |
    And the following "module team members" exist:
      ...
      | TEST1001 | teacher2 |
      | TEST1002 | teacher3 |
    And the following "school admins" exist:
      | school | username |
      | MED | schooladmin |
    ...
    And the following "papers" exist:
      ...
      | summative | A summative exam | teacher | Test module | 60 | monday next week 9:15am | monday next week 11:00am | Europe/London |
  ...
  Scenario: I can change the paper reviewer settings
    ...
    And I should see the following fields:
      ...
      | Internal Reviewers > Mansfield, Peter. Prof | off |
      | External Review > Deadline | 2026-03-19 |
      | External Examiners > Crumpler, Rebecca Lee. Dr | on |
