...
foreach ($papers as $paper) {
  ...
  $url = "https://" . $configObject->get('cfg_test_server') . "/reports/class_totals.php?paperID=" . $paper['paperID'] .
  "&startdate=" . $paper['start_date'] . "&enddate=" . $paper['end_date'] .
  "&repmodule=&repdegree=%&repcourse=%&repyear=%&sortby=student_id&module=&folder=&percent=100&absent=0&studentsonly=1&direction=asc";
  $output = getData($url);
