...
class export_assessmentTest extends unittestdatabase
{
    ...
    public function datageneration(): void
    {
        ...
        $this->question1['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'extmatch',
        ...
        $this->question1['question']['options1'] = $datagenerator->add_options_to_question(array('question' => $this->question1['question']['id'],
            'option_text' => 'Paris',
            'correct' => '1|3|2|||||||',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question1['question']['options2'] = $datagenerator->add_options_to_question(array('question' => $this->question1['question']['id'],
            'option_text' => 'Eifel Tower',
            'correct' => '1|3|2|||||||',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question1['question']['options3'] = $datagenerator->add_options_to_question(array('question' => $this->question1['question']['id'],
            'option_text' => 'Paris Saint-Germain F.C.',
            'correct' => '1|3|2|||||||',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question1['question']['options4'] = $datagenerator->add_options_to_question(array('question' => $this->question1['question']['id'],
            'option_text' => 'Derby',
            'correct' => '1|3|2|||||||',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question1['question']['options5'] = $datagenerator->add_options_to_question(array('question' => $this->question1['question']['id'],
            'option_text' => 'Intu Centre',
            'correct' => '1|3|2|||||||',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question1['question']['options6'] = $datagenerator->add_options_to_question(array('question' => $this->question1['question']['id'],
        ...
        $this->question2['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'dichotomous',
        ...
        $this->question2['question']['options1'] = $datagenerator->add_options_to_question(array('question' => $this->question2['question']['id'],
            'option_text' => 'Italy',
            'correct' => 't',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question2['question']['options2'] = $datagenerator->add_options_to_question(array('question' => $this->question2['question']['id'],
            'option_text' => 'France',
            'correct' => 't',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question2['question']['options3'] = $datagenerator->add_options_to_question(array('question' => $this->question2['question']['id'],
            'option_text' => 'Canada',
            'correct' => 'f',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
        ...
        $this->question3['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'rank',
        ...
        $this->question3['question']['options1'] = $datagenerator->add_options_to_question(array('question' => $this->question3['question']['id'],
            'option_text' => 'One',
            'correct' => '0',
            'marks_correct' => 2,
            'marks_incorrect' => 0,
        ...
        $this->question3['question']['options2'] = $datagenerator->add_options_to_question(array('question' => $this->question3['question']['id'],
            ...
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question3['question']['options3'] = $datagenerator->add_options_to_question(array('question' => $this->question3['question']['id'],
            'option_text' => 'Three',
            'correct' => '1',
            'marks_correct' => 2,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question3['question']['options4'] = $datagenerator->add_options_to_question(array('question' => $this->question3['question']['id'],
            'option_text' => 'Four',
            'correct' => '0',
            'marks_correct' => 2,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question3['question']['options5'] = $datagenerator->add_options_to_question(array('question' => $this->question3['question']['id'],
            'option_text' => 'Five',
            'correct' => '0',
            'marks_correct' => 2,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question3['question']['options6'] = $datagenerator->add_options_to_question(array('question' => $this->question3['question']['id'],
            'option_text' => 'Six',
            'correct' => '0',
            'marks_correct' => 2,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question3['question']['options7'] = $datagenerator->add_options_to_question(array('question' => $this->question3['question']['id'],
            'option_text' => 'Seven',
            'correct' => '0',
            'marks_correct' => 2,
            'marks_incorrect' => 0,
        ...
        $this->question4['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'mcq',
        ...
        $this->question4['question']['options1'] = $datagenerator->add_options_to_question(array('question' => $this->question4['question']['id'],
            'option_text' => 'True',
            'correct' => '1',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question4['question']['options2'] = $datagenerator->add_options_to_question(array('question' => $this->question4['question']['id'],
            'option_text' => 'False',
            'correct' => '1',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question4['question']['options3'] = $datagenerator->add_options_to_question(array('question' => $this->question4['question']['id'],
            'option_text' => 'Maybe',
            'correct' => '1',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
        ...
        $this->question5['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'true_false',
        ...
        $this->question5['question']['options1'] = $datagenerator->add_options_to_question(array('question' => $this->question5['question']['id'],
            'option_text' => '',
            'correct' => '1',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
        ...
        $this->question6['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'enhancedcalc',
        ...
        $this->question7['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'enhancedcalc',
        ...
        $this->question8['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'area',
        ...
        $this->question8['question']['options1'] = $datagenerator->add_options_to_question(array('question' => $this->question8['question']['id'],
            'option_text' => '',
        ...
        $this->question9['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'hotspot',
        ...
        $this->question9['question']['options1'] = $datagenerator->add_options_to_question(array('question' => $this->question9['question']['id'],
            'option_text' => '',
        ...
        $this->question10['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'labelling',
        ...
        $this->question10['question']['options1'] = $datagenerator->add_options_to_question(array('question' => $this->question10['question']['id'],
        ...
        $this->question11['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'sct',
        ...
        $this->question11['question']['options1'] = $datagenerator->add_options_to_question(array('question' => $this->question11['question']['id'],
            'option_text' => 'very unlikely',
            'correct' => '0',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question11['question']['options2'] = $datagenerator->add_options_to_question(array('question' => $this->question11['question']['id'],
            'option_text' => 'unlikely',
            'correct' => '0',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question11['question']['options3'] = $datagenerator->add_options_to_question(array('question' => $this->question11['question']['id'],
            'option_text' => 'neither likely nor unlikely',
            'correct' => '0',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question11['question']['options4'] = $datagenerator->add_options_to_question(array('question' => $this->question11['question']['id'],
            'option_text' => 'more likely',
            'correct' => '0',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question11['question']['options5'] = $datagenerator->add_options_to_question(array('question' => $this->question11['question']['id'],
        ...
        $this->question12['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'textbox',
        ...
        $this->question13['question']  = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'mrq',
            'leadin' => '<div>Which of these wheels belong to a car.</div>',
            'score_method' => 'Mark per Option',
            'q_option_order' => 'display order',
            'settings' => '[]'));
        $this->question13['question']['options1'] = $datagenerator->add_options_to_question(array('question' => $this->question13['question']['id'],
            'option_text' => 'Steering wheel',
            'correct' => 'y',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question13['question']['options2'] = $datagenerator->add_options_to_question(array('question' => $this->question13['question']['id'],
            'option_text' => 'Spare wheel',
            'correct' => 'y',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question13['question']['options3'] = $datagenerator->add_options_to_question(array('question' => $this->question13['question']['id'],
            'option_text' => 'Wheel of Fortune',
            'correct' => 'n',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question13['question']['options4'] = $datagenerator->add_options_to_question(array('question' => $this->question13['question']['id'],
        ...
        $this->question14['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'blank',
            'theme' => 'capitals',
        ...
        $this->question14['question']['options1'] = $datagenerator->add_options_to_question(array('question' => $this->question14['question']['id'],
        ...
        $this->question15['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'matrix',
        ...
        $option5 = '.PUB';
        $option6 = '.DAT';
        $this->question15['question']['options1'] = $datagenerator->add_options_to_question(array('question' => $this->question15['question']['id'],
            'option_text' => $option5,
            'correct' => '3|4|2|5|1|6||||',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question15['question']['options2'] = $datagenerator->add_options_to_question(array('question' => $this->question15['question']['id'],
            'option_text' => $option3,
            'correct' => '3|4|2|5|1|6||||',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question15['question']['options3'] = $datagenerator->add_options_to_question(array('question' => $this->question15['question']['id'],
            'option_text' => $option1,
            'correct' => '3|4|2|5|1|6||||',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question15['question']['options4'] = $datagenerator->add_options_to_question(array('question' => $this->question15['question']['id'],
            'option_text' => $option2,
            'correct' => '3|4|2|5|1|6||||',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question15['question']['options5'] = $datagenerator->add_options_to_question(array('question' => $this->question15['question']['id'],
            'option_text' => $option4,
            'correct' => '3|4|2|5|1|6||||',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question15['question']['options6'] = $datagenerator->add_options_to_question(array('question' => $this->question15['question']['id'],
            'option_text' => $option6,
            'correct' => '3|4|2|5|1|6||||',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
        ...
        $this->question16['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'likert',
        ...
        $this->question16['question']['options1'] = $datagenerator->add_options_to_question(array('question' => $this->question16['question']['id'],
            'correct' => $answer,
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        ...
        $this->question17['question'] = $datagenerator->create_question(array('user' => 'admin',
            'type' => 'random',
            'leadin' => '<div>I experienced&nbsp;no difficulties registering at the University</div>',
            'score_method' => 'Mark per Option',
            'q_option_order' => 'display order',
        ...
        $this->question17['question']['options1'] = $datagenerator->add_options_to_question(array('question' => $this->question17['question']['id'],
            'correct' => '',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question17['question']['options2'] = $datagenerator->add_options_to_question(array('question' => $this->question17['question']['id'],
            'correct' => '',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question17['question']['options3'] = $datagenerator->add_options_to_question(array('question' => $this->question17['question']['id'],
            'correct' => '',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
        $this->question17['question']['options4'] = $datagenerator->add_options_to_question(array('question' => $this->question17['question']['id'],
            'correct' => '',
            'marks_correct' => 1,
            'marks_incorrect' => 0,
            'marks_partial' => 0));
    ...
    public function test_create_data()
    {
        ...
        // Text export.
        $mode = 'text';
        $expected = array(1 => array(null, 'Dr', 'User1', 'A', '1234567890', 'TEST2', 1, '2018-01-01 09:00:00',
            $this->question1['question']['options1']['option_text'],
            $this->question1['question']['options3']['option_text'],
            $this->question1['question']['options2']['option_text'],
            $this->question2['question']['options1']['correct'],
