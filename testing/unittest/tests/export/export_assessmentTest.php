...
class export_assessmentTest extends unittestdatabase
{
    ...
    public function datageneration(): void
    {
        ...
        $datagenerator->create_enrolment(['userid' => $this->student['id'], 'moduleid' => 1, 'calendar_year' => 2018]);
        ...
        $meta = $logdatagenerator->create_metadata(['userID' => $this->student['id'], 'paperID' => $this->pid1['id'], 'started' => '2018-01-01 09:00:00', 'year' => 1]);
        ...
        $meta2 = $logdatagenerator->create_metadata(['userID' => $this->student['id'], 'paperID' => $this->pid2['id'], 'started' => '2018-01-01 09:00:00', 'year' => 1]);
        ...
        $logdatagenerator->create_summative(['q_id' => $this->question1['question']['id'], 'metadataID' => $meta['id'], 'screen' => 1, 'user_answer' => '1|3|2', 'mark' => 3, 'adjmark' => 3]);
        ...
        $datagenerator->add_question_to_paper(['paper' => $this->pid1['id'], 'question' => $this->question1['question']['id'], 'screen' => 1, 'displaypos' => 1]);
        ...
        $logdatagenerator->create_summative(['q_id' => $this->question2['question']['id'], 'metadataID' => $meta['id'], 'screen' => 2, 'user_answer' => 'ttf', 'mark' => 3, 'adjmark' => 3]);
        ...
        $datagenerator->add_question_to_paper(['paper' => $this->pid1['id'], 'question' => $this->question2['question']['id'], 'screen' => 2, 'displaypos' => 2]);
        ...
        $logdatagenerator->create_summative(['q_id' => $this->question3['question']['id'], 'metadataID' => $meta['id'], 'screen' => 3, 'user_answer' => '0,2,1,0,0,0,0', 'mark' => 14, 'adjmark' => 14]);
        ...
        $this->question3['question']['options2'] = $datagenerator->add_options_to_question(['question' => $this->question3['question']['id'],
            'option_text' => 'Two',
            'correct' => '2',
            'marks_correct' => 2,
            'marks_incorrect' => 0,
        ...
        $datagenerator->add_question_to_paper(['paper' => $this->pid1['id'], 'question' => $this->question3['question']['id'], 'screen' => 3, 'displaypos' => 3]);
        ...
        $logdatagenerator->create_summative(['q_id' => $this->question4['question']['id'], 'metadataID' => $meta['id'], 'screen' => 4, 'user_answer' => '1', 'mark' => 1, 'adjmark' => 1]);
        ...
        $datagenerator->add_question_to_paper(['paper' => $this->pid1['id'], 'question' => $this->question4['question']['id'], 'screen' => 4, 'displaypos' => 4]);
        ...
        $logdatagenerator->create_summative(['q_id' => $this->question5['question']['id'], 'metadataID' => $meta['id'], 'screen' => 5, 'user_answer' => 'f', 'mark' => 1, 'adjmark' => 1]);
        ...
        $datagenerator->add_question_to_paper(['paper' => $this->pid1['id'], 'question' => $this->question5['question']['id'], 'screen' => 5, 'displaypos' => 5]);
        ...
        $logdatagenerator->create_summative(['q_id' => $this->question6['question']['id'], 'metadataID' => $meta['id'], 'screen' => 6, 'user_answer' => '{"vars":{"$A":6,"$B":6},"uans":"36","uansunit":"","uansnumb":"36","ans":{"guessedunits":"","formula_used":"$A*$B","units_used":"cm","tolerance_full":0,"tolerance_fullans":36,"tolerance_fullansneg":36,"tolerance_partial":0,"tolerance_partialans":36,"tolerance_partialansneg":36},"status":{"units":false,"exact":false,"overall":0},"cans":36}', 'mark' => 0, 'adjmark' => 0]);
        $datagenerator->add_question_to_paper(['paper' => $this->pid1['id'], 'question' => $this->question6['question']['id'], 'screen' => 6, 'displaypos' => 6]);
        ...
        $logdatagenerator->create_summative(['q_id' => $this->question8['question']['id'], 'metadataID' => $meta['id'], 'screen' => 8, 'user_answer' => $useranswer, 'mark' => 0, 'adjmark' => 0]);
        ...
        $datagenerator->add_question_to_paper(['paper' => $this->pid1['id'], 'question' => $this->question8['question']['id'], 'screen' => 8, 'displaypos' => 8]);
        ...
        $logdatagenerator->create_summative(['q_id' => $this->question9['question']['id'], 'metadataID' => $meta['id'], 'screen' => 9, 'user_answer' => '1,330,995', 'mark' => 1, 'adjmark' => 1]);
        ...
        $datagenerator->add_question_to_paper(['paper' => $this->pid1['id'], 'question' => $this->question9['question']['id'], 'screen' => 9, 'displaypos' => 9]);
        ...
        $logdatagenerator->create_summative(['q_id' => $this->question10['question']['id'], 'metadataID' => $meta['id'], 'screen' => 10, 'user_answer' => '4$4;370$148$beetle3.png$t$371$275$earwig3.png$t$537$78$spider$t$539$447$plants$t$', 'mark' => 4, 'adjmark' => 4]);
        ...
        $datagenerator->add_question_to_paper(['paper' => $this->pid1['id'], 'question' => $this->question10['question']['id'], 'screen' => 10, 'displaypos' => 10]);
        ...
        $useranswer = '1';
        $logdatagenerator->create_summative(['q_id' => $this->question11['question']['id'], 'metadataID' => $meta['id'], 'screen' => 11, 'user_answer' => $useranswer, 'mark' => 0, 'adjmark' => 0]);
        ...
        $datagenerator->add_question_to_paper(['paper' => $this->pid1['id'], 'question' => $this->question11['question']['id'], 'screen' => 11, 'displaypos' => 11]);
        ...
        $logdatagenerator->create_summative(['q_id' => $this->question12['question'] ['id'], 'metadataID' => $meta['id'], 'screen' => 12, 'user_answer' => $useranswer]);
        $this->question12['question']['options1']['expected']['useranswer'] = $useranswer;
        $datagenerator->add_question_to_paper(['paper' => $this->pid1['id'], 'question' => $this->question12['question']['id'], 'screen' => 12, 'displaypos' => 12]);
        ...
        $logdatagenerator->create_summative(['q_id' => $this->question13['question']['id'], 'metadataID' => $meta['id'], 'screen' => 13, 'user_answer' => 'yynn', 'mark' => 2, 'adjmark' => 2]);
        $datagenerator->add_question_to_paper(['paper' => $this->pid1['id'], 'question' => $this->question13['question']['id'], 'screen' => 13, 'displaypos' => 13]);
        ...
        $useranswer = 'England';
        $logdatagenerator->create_summative(['q_id' => $this->question14['question']['id'], 'metadataID' => $meta['id'], 'screen' => 14, 'user_answer' => '["' . $useranswer . '"]', 'mark' => 1, 'adjmark' => 1]);
        ...
        $datagenerator->add_question_to_paper(['paper' => $this->pid1['id'], 'question' => $this->question14['question']['id'], 'screen' => 14, 'displaypos' => 14]);
        ...
        $logdatagenerator->create_summative(['q_id' => $this->question15['question']['id'], 'metadataID' => $meta['id'], 'screen' => 15, 'user_answer' => '3|4|2|5|1|6', 'mark' => 6, 'adjmark' => 6]);
        $option1 = '.DOC';
        $option2 = '.XLS';
        $option3 = '.PPT';
        $option4 = '.MDB';
        ...
        $datagenerator->add_question_to_paper(['paper' => $this->pid1['id'], 'question' => $this->question15['question']['id'], 'screen' => 15, 'displaypos' => 15]);
        ...
        $useranswer = '3';
        $answer = 'NULL';
        $logdatagenerator->create_summative(['q_id' => $this->question16['question']['id'], 'metadataID' => $meta['id'], 'screen' => 16, 'user_answer' => $useranswer, 'mark' => 0, 'adjmark' => 0]);
        ...
        $datagenerator->add_question_to_paper(['paper' => $this->pid1['id'], 'question' => $this->question16['question']['id'], 'screen' => 16, 'displaypos' => 16]);
        ...
        $datagenerator->add_to_random_block(['question' => $this->question2['question']['id'], 'block' => $this->question17['question']['id']]);
        $datagenerator->add_to_random_block(['question' => $this->question3['question']['id'], 'block' => $this->question17['question']['id']]);
        $datagenerator->add_to_random_block(['question' => $this->question5['question']['id'], 'block' => $this->question17['question']['id']]);
        $datagenerator->add_to_random_block(['question' => $this->question13['question']['id'], 'block' => $this->question17['question']['id']]);
        ...
        $this->question17['question']['options5'] = $datagenerator->add_question_to_paper(['paper' => $this->pid2['id'], 'question' => $this->question17['question']['id'], 'screen' => 1, 'displaypos' => 1]);

        $logdatagenerator->create_summative(['q_id' => $this->question17['question']['id'], 'metadataID' => $meta2['id'], 'screen' => 1, 'user_answer' => 'f', 'mark' => 1, 'adjmark' => 1]);
    }
