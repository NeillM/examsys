...
class questions extends generator {
    ...
    public function insert_question($data) {
        ...
        $username = $data['user'];
        $userid = \testing\datagenerator\papers::test_get_useridbyname($username, $db);
        ...
        $qdata = array_merge($defult, $data);
        //$params = array_merge(array('ssssssssssssssissssisssssss'), $qdata);
        $sqlquery = <<< SQLQUERY
...
SQLQUERY;
        try {
            ...
            $result->bind_param('ssssssssssssssissssisssssss', $qdata['q_type'], $qdata['theme'], $qdata['scenario'], $qdata['scenario_plain'], $qdata['leadin'], $qdata['leadin_plain'], $qdata['notes'], $qdata['correct_fback'], $qdata['incorrect_fback'], $qdata['score_method'], $qdata['
display_method'], $qdata['q_option_order'], $qdata['std'], $qdata['bloom'], $qdata['ownerID'], $qdata['q_media'], $qdata['q_media_width'], $qdata['q_media_height'], $qdata['checkout_time'], $qdata['checkout_authorID'], $qdata['
creation_date'], $qdata['last_edited'], $qdata['locked'], $qdata['deleted'], $qdata['status'], $qdata['settings'], $qdata['guid']);
