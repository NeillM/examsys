...
class papers extends generator {
    ...
    public function create_paper($parameters) {
        ...
        if (empty($parameters['papertitle']) or !is_numeric($parameters['papertype']) or empty($parameters['paperowner']) or empty($parameters['modulename'])) {
            ...
            $paperowner = (int) $this->test_get_useridbyname($parameters['paperowner'], $db);
     ...
     * @return int moduleid
     */
    static function test_get_moduleidbyname($modulename, $db) {
     ...
     * @return int userid
     */
    public static function test_get_useridbyname($username, $db) {
