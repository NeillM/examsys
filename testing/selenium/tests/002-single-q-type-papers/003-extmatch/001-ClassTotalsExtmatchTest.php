...
class ClassTotalsExtmatchTest extends PHPUnit_Extensions_SeleniumTestCase
{
  ...
  public function testResults() {
    ...
    $this->open("/reports/class_totals.php?paperID=3&startdate=20130102000000&enddate=20130117150000&repmodule=&repcourse=%&sortby=name&module=3&folder=&percent=100&absent=0&studentsonly=1&direction=asc");
    ...
    // Total marks
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[6]/td[2]', '162');
    // Mean
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[8]/td[2]', '40.5');
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[8]/td[3]', '(25%)');
    // Median
    ...
    // Standard Deviation
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[10]/td[2]', '89.81');
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[10]/td[3]', '(55.3%)');
    // Max
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[11]/td[2]', '162');
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[11]/td[3]', '(100%)');
    // Min
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[12]/td[2]', '-47.5');
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[12]/td[3]', '(-29%)');
    // Range
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[13]/td[2]', '209.5');
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[13]/td[3]', '(129%)');
    // Top 10%
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[14]/td[2]', '78.7%');
    // Top 15%
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[15]/td[2]', '68.05%');
    // Top 20%
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[16]/td[2]', '57.4%');
    // Top 25%
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[17]/td[2]', '46.75%');
    // Bottom 10%
    $this->assertElementContainsText('//table/tbody/tr[21]/td/table/tbody/tr[18]/td[2]', '-20.3%');
  }
}
?>