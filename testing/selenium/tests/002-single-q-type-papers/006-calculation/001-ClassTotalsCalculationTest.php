...
class ClassTotalsCalculationTest extends PHPUnit_Extensions_SeleniumTestCase
{
  ...
  public function testResults() {
    ...
    $this->open("/reports/class_totals.php?paperID=6&startdate=20130101000000&enddate=20130215120000&repmodule=&repcourse=%&sortby=name&module=3&folder=&percent=100&absent=0&studentsonly=1&direction=asc");
