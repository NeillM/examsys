...
class ClassTotalsBlankTest extends PHPUnit_Extensions_SeleniumTestCase
{
  ...
  public function testResults() {
    ...
    $this->open("/reports/class_totals.php?paperID=5&startdate=20130101000000&enddate=20130210130000&repmodule=&repcourse=%&sortby=name&module=3&folder=&percent=100&absent=0&studentsonly=1&direction=asc");
