...
class RunAsStudentMRQTest extends PHPUnit_Extensions_SeleniumTestCase
{
  ...
  public function testClassTotals() {
    ...
    $this->open("/reports/class_totals.php?paperID=2&startdate=20120113000000&enddate=20230117150000&repmodule=&repcourse=%&sortby=name&module=3&folder=&percent=100&absent=0&studentsonly=1&direction=asc");

    // Individuals
    $this->assertElementContainsText('//tr[@id="res5"]/td[5]', '-9');
    $this->assertElementContainsText('//tr[@id="res5"]/td[6]', '-33%');
    $this->assertElementContainsText('//tr[@id="res5"]/td[7]', 'Fail');

    $this->assertElementContainsText('//tr[@id="res6"]/td[5]', '27');
    $this->assertElementContainsText('//tr[@id="res6"]/td[6]', '100%');
    $this->assertElementContainsText('//tr[@id="res6"]/td[7]', 'Distinction');

    $this->assertElementContainsText('//tr[@id="res7"]/td[5]', '-9');
    $this->assertElementContainsText('//tr[@id="res7"]/td[6]', '-33%');
    $this->assertElementContainsText('//tr[@id="res7"]/td[7]', 'Fail');

    $this->assertElementContainsText('//tr[@id="res8"]/td[5]', '3.5');
    $this->assertElementContainsText('//tr[@id="res8"]/td[6]', '13%');
