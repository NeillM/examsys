                ...
                <tr>
                    <td>
                        <table border="0" cellspacing="6" cellpadding="0" style="background-color:#F1F5FB">
                            ...
                            <tr>
                                <td align="right"><span class="field"><?php echo $string['title']; ?></span></td>
                                <td>
                            ...
                            <tr>
                                <td align="right"><span class="field"><?php echo $string['gender']; ?></span></td>
                                <td>
                            ...
                            <tr>
                                <td align="right"><span class="field"><?php echo $string['name']; ?></span></td>
                                <td>
                                    <input type="text" id="new_grade2" name="new_grade2" size="40"
                                           value="<?php if (isset($_POST['new_grade2'])) echo $_POST['new_grade2']; ?>"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <input type="submit" name="submit" value="<?php echo $string['createaccount']; ?>"/>
                                </td>
                            </tr>
                        </table>
                    </td>
