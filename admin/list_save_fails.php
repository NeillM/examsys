...
<div class="head_title">
  ...
  <div class="page_title">Save Fail Attempts</div>
</div>
...
<tbody>
<?php
$result = $mysqli->prepare("SELECT surname, title, initials, userID, paperID, ipaddress, FROM_UNIXTIME(failed, '%d/%m/%Y %H:%i:%s'), paper_title FROM save_fail_log, users, properties WHERE save_fail_log.userID = users.id AND save_fail_log.paperID = properties.property_id ORDER BY failed");
$result->execute();
$result->store_result();
