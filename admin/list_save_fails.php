...
<head>
  ...
  <style>
    .clearall{float: right;margin-top: 0.4em;color: red;margin-right: 7%;font-size: 0.7em;text-decoration: none;}
...
<div class="head_title">
  ...
  <div class="page_title"><?php echo $string['savefailattempts'] ?> <a class="clearall" href="?clear=all" onclick="return clearAll()"><?php echo $string['clear_all_button_text']; ?></a></div>
</div>
