...
<tr><th><div class="col10"><?php echo $string['date']; ?></div></th><th class="vert_div">&nbsp;<?php echo $string['type']; ?></th><th class="vert_div">&nbsp;<?php echo $string['message']; ?></th><th class="vert_div">&nbsp;<?php echo $string['file']; ?></th><th class="vert_div"><nobr>&nbsp;<?php echo $string['lineno']; ?>&nbsp;</th><th class="vert_div">&nbsp;<?php echo $string['user']; ?></th><th class="vert_div">&nbsp;<?php echo $string['userid']; ?>&nbsp;</th></tr>
