...
?>
  ...
  <div class="head_title">
    ...
    <div class="breadcrumb"><a href="../index.php"><?php echo $string['home'] ?></a><a href="./index.php"><?php echo $string['administrativetools'] ?></a><a href="list_courses.php"><?php echo $string['courses'] ?></a></div>
