...
<tr>
<td class="field"><?php echo $string['Staff Message'] ?></td><td><?php $texteditorplugin->get_textarea('staff_msg', 'staff_msg', '', plugins\plugins_texteditor::type_standard); ?></td>
</tr>
<tr>
<td class="field"><?php echo $string['Student Message'] ?></td><td><?php $texteditorplugin->get_textarea('student_msg', 'student_msg', '', plugins\plugins_texteditor::type_standard); ?></td>
</tr>
<tr>
