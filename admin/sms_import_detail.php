...
<div class="head_title">
  ...
  <div class="breadcrumb"><a href="../index.php"><?php echo $string['home'] ?></a><a href="./index.php"><?php echo $string['administrativetools']; ?></a><a href="./list_modules.php"><?php echo $string['modules']; ?></a><a href="sms_import_summary.php"><?php echo $string['smsimportsummary']; ?></a></div>
