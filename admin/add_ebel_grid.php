...
<head>
  ...
  <title><?php echo page::title('ExamSys: ' . $string['createtemplate']); ?></title>
...
<body>
  ...
  <div class="head_title">
    ...
    <div class="breadcrumb"><a href="../index.php"><?php echo $string['home'] ?></a><a href="./index.php"><?php echo $string['administrativetools']; ?></a><a href="./list_ebel_grids.php"><?php echo $string['ebelgridtemplates'] ?></a></div>
