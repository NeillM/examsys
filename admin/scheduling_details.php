...
<head>
  ...
  <title><?php echo page::title('ExamSys: ' . $string['summativeexamdetails']); ?></title>
...
<div class="head_title">
  ...
  <div class="breadcrumb"><a href="../index.php"><?php echo $string['home']; ?></a><a href="./index.php"><?php echo $string['administrativetools'] ?></a><a href="summative_scheduling.php"><?php echo $string['summativescheduling'] ?></a></div>
