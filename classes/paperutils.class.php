...
Class PaperUtils {
  ...
  */
   ...
   *
   */
  public static function randomQOverwrite($random_q_data, $user_answers, &$screen_data, &$used_questions, $string) {
    $configObject = \Config::get_instance();
    $db = $configObject->db;
    $selected_q_id = '';
   ...
   *
   */
  public static function keywordQOverwrite($random_q_data, $user_answers, &$screen_data, &$used_questions, $string) {
    $configObject = \Config::get_instance();
    $db = $configObject->db;
    $selected_q_id = '';
    $unique = true;
