...
?>
  ...
  */
  ...
  static function createConstraints() {
    ...
    $alter[] = "ALTER TABLE keywords_option ADD CONSTRAINT keywords_options_fk2 FOREIGN KEY (keyword_id) REFERENCES keywords_question(keywordID)";
    foreach ($alter as $a) {
  ...
  */
  static function createDatabase($dbname, $dbcharset) {
   ...
   //$priv_SQL[] = "REVOKE ALL PRIVILEGES ON $dbname.* FROM '". self::$cfg_db_student_user . "'@'". self::$cfg_web_host . "'";
    ...
    $priv_SQL[] = "GRANT SELECT ON " . $dbname . ".keywords_options TO '". self::$cfg_db_student_user . "'@'". self::$cfg_web_host . "'";
   ...
   self::$db->commit();
    ...
    $priv_SQL[] = "GRANT SELECT ON " . $dbname . ".keywords_options TO '" . self::$cfg_db_external_user . "'@'". self::$cfg_web_host . "'";
   ...
   self::$db->commit();
    ...
    $priv_SQL[] = "GRANT SELECT, INSERT, UPDATE, DELETE ON " . $dbname . ".keywords_options TO '". self::$cfg_db_staff_user . "'@'". self::$cfg_web_host . "'";
