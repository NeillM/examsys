  ...
  */
  static function createDatabase($dbname, $dbcharset) {
   ...
   self::$db->commit();
    ...
    $priv_SQL[] = "REVOKE SELECT ON" . $dbname . ".plugins FROM '". self::$cfg_db_staff_user . "'@'". self::$cfg_web_host . "'";
   ...
   self::$db->commit();
    ...
    $priv_SQL[] = "REVOKE SELECT ON" . $dbname . ".plugins FROM '". self::$cfg_db_webservice_user . "'@'". self::$cfg_web_host . "'";
