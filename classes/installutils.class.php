...
CONFIG;
    ...
    $lookup_arrays= array();
    if ((!self::$cli and self::$cfg_uselookupLdap) or (self::$cli and self::getSettings(param::BOOLEAN, false, 'lookup', 'ldap'))) {
    ...
    if ((!self::$cli and self::$cfg_uselookupXML) or (self::$cli and self::getSettings(param::BOOLEAN, false, 'lookup', 'xml'))) {
