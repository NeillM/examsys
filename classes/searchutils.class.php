...
Class search_utils {
  ...
  static function display_staff_modules_dropdown($userObj, $string, $db) {
    ...
    echo "<select style=\"width:198px\" onchange=\"updateDropdownState(this,'module')\" name=\"module\">\n";
  ...
  static function display_owners_dropdown($userObj, $db, $type, $string, $state, $font_size = 90) {
    ...
    echo "<select style=\"width:198px; font-size:$font_size%\" onchange=\"updateDropdownState(this,'owner')\" name=\"owner\">\n";
...
STATUS;
  ...
  static function display_blooms_dropdown($string, $state) {
    ...
    echo "<select style=\"width:198px\" onchange=\"updateDropdownState(this,'bloom')\" name=\"bloom\">\n";
