...
class StandardSetting {
  ...
  public static function copy_std_setting_to_paper_linked(int $old_paper_id, int $new_paper_id) {
    ...
    foreach ($std_settings_from as $old_std_id => $std_setting_data) {
      $new_std_id = self::new_std_set($new_paper_id, $std_setting_data['setter_id'], $std_setting_data['std_set'],
        $std_setting_data['method'], $std_setting_data['group_review'], $std_setting_data['pass_score'],
        $std_setting_data['distinction_score'], $db);
