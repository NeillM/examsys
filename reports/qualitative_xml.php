...
*/
  ...
  echo date('Y-m-d', time()) . 'T' . date('H:i:s') . 'Z';
  echo '</o:LastSaved><o:Pages>1</o:Pages><o:Company>' . $configObject->get_setting('core', 'misc_company') . '</o:Company>';
