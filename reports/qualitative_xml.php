...
*/
  ...
  echo '</o:Title><o:Author>Rogo ' . $configObject->get('rogo_version') . '</o:Author><o:Description>Quanlitative report for survey taken between ' . $tmp_start . ' and ' . $tmp_end .'.</o:Description><o:LastAuthor>Rogo ' . $rogo_version . '</o:LastAuthor><o:Revision>1</o:Revision><o:TotalTime>0</o:TotalTime><o:Created>';
