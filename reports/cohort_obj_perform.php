  ...
  if (count($objByModule) == 0) {
    ...
    foreach($objectives as $id => $obj_data) {
      ...
      if (isset($obj_data['session']['specificguide'])) {
        $session_string = "&nbsp;&nbsp;<a target=\"_blank\" href=\"" . $configObject->get('cfg_nle_url') . "/displayMediGuide.php?module=" . $module . "&session=" . $session . "&specificguide=" . $obj_data['session']['specificguide'] . "&mk=" . $tmp_identifier . "\"><img src=\"../artwork/small_link.png\" width=\"11\" height=\"11\" /></a>&nbsp;<a target=\"_blank\" href=\"" . $configObject->get('cfg_nle_url') . "/displayMediGuide.php?module=" . $module . "&session=" . $session . "&specificguide=" . $obj_data['session']['specificguide'] . "&mk=" . $tmp_identifier . "\">" . $obj_data['session']['sessiontitle'] . "</a>";
      }
