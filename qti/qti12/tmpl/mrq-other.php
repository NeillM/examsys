...
<?php endforeach; ?>	
					<response_label ident='OTHER'>
						<material>
							<mattext texttype='text/html'>Other (Enter Below)</mattext>
						</material>
					</response_label>				
				</render_choice>
			</response_lid>
			<response_str ident="OTHER" rcardinality="Single">
				<render_fib>
					<material>
						<mattext texttype="text/html">Other: </mattext>
					</material>
					<response_label ident="OTHER"/>
				</render_fib>
			</response_str>
