...
if ($updater_utils->check_version("6.1.0")) {
    ...
    if (!$updater_utils->has_updated('rogo1559_webserviceuser')) {
        ...
        $cfg_db_webservice_passwd = $enc->gen_password(false, 16);
    
        $createsql ="CREATE USER  '" . $cfg_db_webservice_user . "'@'" . $cfg_web_host . "' IDENTIFIED BY '" . $cfg_db_webservice_passwd['password'] . "'";
