...
if (!$updater_utils->does_table_exist('academic_year')) {
    ...
    $grantsql->execute_query($grantsql, true);
    ...
    $updater_utils->execute_query($grantsql, true);
    $grantsql = "GRANT SELECT ON " . $cfg_db_database . ".academic_year TO '" . $cfg_db_inv_user . "'@'" . $cfg_web_host . "'";
    $updater_utils->execute_query($grantsql, true);

    // Default data
    $insertsql = "INSERT INTO academic_year VALUES (2002,'2002/03',0,0), (2003,'2003/04',0,0), (2004,'2004/05',0,0), (2005,'2005/06',0,0), "
      . "(2006,'2006/07',0,0), (2007,'2007/08',0,0), (2008,'2008/09',0,1), (2009,'2009/10',0,1), (2010,'2010/11',0,1), (2011,'2011/12',0,1), "
      . "(2012,'2012/13',1,1), (2013,'2013/14',1,1), (2014,'2014/15',1,1), (2015,'2015/16',1,1), (2016,'2016/17',1,0), (2017,'2017/18',0,0), "
      . "(2018,'2018/19',0,0), (2019,'2019/20',0,0)";
    ...
    if (!$updater_utils->has_updated('rogo1481alter_users_metadata')) {
        ...
        $altersql = "ALTER TABLE users_metadata ADD CONSTRAINT users_metadata_fk0 FOREIGN KEY (calendar_year) REFERENCES academic_year(id)";
        $updater_utils->execute_query($altersql, true);
    ...
    if (!$updater_utils->has_updated('rogo1481alter_sms_imports')) {
        ...
        $altersql = "ALTER TABLE sms_imports ADD CONSTRAINT sms_imports_fk0 FOREIGN KEY (academic_year) REFERENCES academic_year(id)";
        $updater_utils->execute_query($altersql, true);
    ...
    if (!$updater_utils->has_updated('rogo1481alter_sessions')) {
        ...
        $altersql = "ALTER TABLE sessions ADD CONSTRAINT sessions_fk0 FOREIGN KEY (calendar_year) REFERENCES academic_year(id)";
        $updater_utils->execute_query($altersql, true);
    ...
    if (!$updater_utils->has_updated('rogo1481alter_relationships')) {
        ...
        $altersql = "ALTER TABLE relationships ADD CONSTRAINT relationships_fk0 FOREIGN KEY (calendar_year) REFERENCES academic_year(id)";
        $updater_utils->execute_query($altersql, true);
    ...
    if (!$updater_utils->has_updated('rogo1481alter_properties')) {
        ...
        $altersql = "ALTER TABLE properties ADD CONSTRAINT properties_fk0 FOREIGN KEY (calendar_year) REFERENCES academic_year(id)";
        $updater_utils->execute_query($altersql, true);
    ...
    if (!$updater_utils->has_updated('rogo1481alter_objectives')) {
        ...
        $altersql = "ALTER TABLE objectives ADD CONSTRAINT objectives_fk0 FOREIGN KEY (calendar_year) REFERENCES academic_year(id)";
        $updater_utils->execute_query($altersql, true);
    ...
    if (!$updater_utils->has_updated('rogo1481alter_modules_student')) {
        ...
        $updater_utils->execute_query($updatesql, true);
        $updatesql = "UPDATE modules_student SET calendar_year = 2013 WHERE calendar_year = 6";
        $updater_utils->execute_query($updatesql, true);
        ...
        $updater_utils->execute_query($updatesql, true);
        $updatesql = "UPDATE modules_student SET calendar_year = 2016 WHERE calendar_year = 9";
        $updater_utils->execute_query($updatesql, true);
        $updatesql = "UPDATE modules_student SET calendar_year = 2017 WHERE calendar_year = 10";
        $updater_utils->execute_query($updatesql, true);
        $updatesql = "UPDATE modules_student SET calendar_year = 2018 WHERE calendar_year = 11";
        $updater_utils->execute_query($updatesql, true);
        $updatesql = "UPDATE modules_student SET calendar_year = 2019 WHERE calendar_year = 12";
        $updater_utils->execute_query($updatesql, true);

        $altersql = "ALTER TABLE modules_student ADD CONSTRAINT modules_student_fk0 FOREIGN KEY (calendar_year) REFERENCES academic_year(id)";
        $updater_utils->execute_query($altersql, true);
