...
*/
  ...
  if ($paper_no == 1) {
    ...
    echo "<h1 style=\"margin-left:60px\">TouchStone cannot find any OSCE Stations</h1>\n";
    echo "<hr size=\"1\" align=\"left\" width=\"500\" style=\"margin-left:60px; color:#C0C0C0; background-color:#C0C0C0\" />\n";
    exit;
  } else {
    echo "<html>\n<head>\n<title>Exams</title>\n</head>\n<body style=\"font-family:Arial,sans-serif\">\n";
    echo "<h1>Multiple OSCE Stations Found</h1>\n";
    echo "<p><em>Please select the one you wish to examine:</em></p>\n";
