...
$string['title'] = 'Tytuł:';
$string['title_types'] = "Mx,Pani,Pan,Mgr,Dr,Prof.";
...
$string['errors8'] = 'Rog&#333; wymaga serwera Apache w wersji %s';
$string['errors9'] = 'Rog&#333; wymaga serwera Apache w wersji %s lub wyższej %s';
$string['errors10'] = 'Rog&#333; wymaga serwera PHP w wersji %s lub wyższej %s';
$string['errors11'] = 'Rog&#333; wymaga aby moduł PHP %s funkcjonował - zainstaluj go lub aktywuj.';
