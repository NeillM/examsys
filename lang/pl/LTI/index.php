...
$string['NoPapersDesc'] = 'Brak arkuszy dla tego modułu.  Być może wynika to z faktu, że właśnie utworzyłeś link z VLE wraz z nowym modułem i stąd nie masz jeszcze skonfigurowanych żadnych arkuszy.<br /><br />Please <a href="../" target="_blank">launch Rogo</a> to create a paper'; //close the browser (<strong>very important</strong>) and then go to the Rogo homepage and create a paper.  // TODO Niko
