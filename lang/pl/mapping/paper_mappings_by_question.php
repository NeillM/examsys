...
$string['mappingbyquestion'] = 'Odwzorowanie wg. pytania';
...
$string['noquestiononscreen'] = 'na tym ekranie nie ma pytań.<br />Spowoduje to wystapienie błędu podczas testowania arkusza!';//en
$string['questiononnotmap'] = 'To pytanie nie ma odniesienia w module!';//en
?>