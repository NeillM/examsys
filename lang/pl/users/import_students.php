...
$string['msg1'] = 'TouchStone może skomasować ładowanie danych studentów i tworzenie nowych kont z plików CSV. <br />Pierwszy wiersz powinien być wierszem nagłówkowym zawierającym następujące pola:';
