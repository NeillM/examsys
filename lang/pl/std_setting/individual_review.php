...
$string['step2'] = '<strong>Krok 2: Siatka zaliczenia</strong><br />Dla każdej kategorii (np. łatwe/kluczowe, łatwe/ważne itp.) określ oczekiwany procent <strong>granicznych kandydatów</strong>, którzy odpowiedzą prawidłowo na pytania w tej kategorii.';
