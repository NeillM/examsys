...
$string['markswarning'] = 'Ekran %d ma %d punkty/ów, co jest %d%% całej liczby punktów tego arkusza. Wprowadź dodatkowe przerwy ekranowe w celu zminimalizowania start danych w przypadku zawieszenia komputera.';// Please insert additional screen breaks to minimise data loss in the event of a computer crash.';
