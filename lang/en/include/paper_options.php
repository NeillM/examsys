...
$string['importoscemarks'] = 'Import OSCE Marks';
$string['copypaper'] = 'Copy Paper';
$string['deletepaper'] = 'Delete Paper';
$string['retirepaper'] = 'Retire Paper';
$string['printhardcopy'] = 'Print Hardcopy version';
$string['importexport'] = 'Import/Export';
$string['export12'] = 'Export as QTI 1.2 format';
$string['exportraf'] = 'Export as ExamSys Assessment format';
$string['import'] = 'Import QTI format';
$string['importraf'] = 'Import ExamSys Assessment format';
$string['Continuous'] = 'Continuous';
$string['Page-break per question'] = 'Page-break per question';
$string['Continuous - hide notes'] = 'Continuous - hide notes';
$string['Page-break per question - hide notes'] = 'Page-break per question - hide notes';
$string['currentquestiontasks'] = 'Question Tasks';
...
$string['changescreenno'] = 'Change Screen No.';
$string['removefrompaper'] = 'Remove from Paper';
$string['setkillerquestion'] = 'Set Killer Question';
$string['unsetkillerquestion'] = 'Unset Killer Question';
...
$string['peerreviewed'] = 'Peer Reviewed';
$string['peerreviewes'] = 'Peer Reviews';
$string['externalreviews'] = 'External Reviews';
$string['standardsset'] = 'Standards Set';
...
$string['classtotalscsv'] = 'Class Totals (CSV file)';
$string['textboxmarking'] = 'Textbox Marking';
$string['calculationquestions'] = 'Calculation Questions';
$string['markallquestions'] = 'Mark all questions';
...
$string['exportratingscsv'] = 'Export ratings as CSV file';
$string['ReviewSummary1'] = 'Review Summary - means (HTML)';
$string['ReviewSummary2'] = 'Review Summary - percents (HTML)';
$string['ReviewSummary3'] = 'Review Summary';
$string['ReviewSummary4'] = 'Review Summary - means (CSV)';
...
$string['rawdataxml'] = 'Raw data as XML file';
$string['rawdatacsv'] = 'Raw data as CSV file';
...
$string['incabsentcandidates'] = 'inc. absent candidates';
$string['studentsonly'] = 'student attempts only';
$string['completedatasets'] = 'Show complete datasets only';
