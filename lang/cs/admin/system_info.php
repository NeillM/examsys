...
$string['rogoplugins'] = 'Rogō plug-ins';	// translate
$string['EnhancedCalcPlugin'] = 'Calculation question';	// translate
$string['ErrorLogSettings'] = 'Error Reporting';	// translate
$string['authdebug'] = 'Show authentication debug';	// translate
$string['errorsonscreen'] = 'Show errors on-screen';	// translate
$string['phpnotices'] = 'Show PHP Notices';	// translate
$string['errorshutdown'] = 'Error handling at shutdown';	// translate
$string['varcapturemethod'] = 'Variable capture method on error:';	// translate
$string['improved'] = 'Improved';	// translate
$string['basic'] = 'Basic';	// translate
$string['none'] = 'none';	// translate
$string['company'] = 'Company';	// translate
