...
$string['name'] = 'Popisný název';
$string['oauth_consume_key']= 'OAuth spotřebitelský klíč';
$string['oauth_secret'] = 'OAuth bezpečnostní spotřebitelský klíč';
$string['oauth_context_id'] = 'Přepsat LTI kontextové ID';
$string['createLTIkeys'] = 'Nový LTI klíč ';
