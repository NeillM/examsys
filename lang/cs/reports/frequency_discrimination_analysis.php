...
$string['p_warning'] = '<strong>p < 0.2</strong> (t.j. velmi těžké)';
$string['d_warning'] = "<strong>d < 0.15</strong> (t.j. slabá)<br />Zjištěna signalizace možného nedostatku,  pokud usoudíte, že je položka špatná, odstraníte ji z oběhu pomocí ikony <img src=\"../artwork/exclude_off.gif\" style=\"cursor:pointer\" width=\"23\" height=\"22\" border=\"0\" alt=\"Vyloučit\" /> a potvrdíte kliknutím na tlačítko 'Uložit' ve spodní části okna";
$string['summary'] = 'Přehled';
$string['msg'] = 'Počet položek může být větší než počet úloh, jelikož, kupříkladu, dichotomické úlohy, popisky a úlohy s výběrem odpovědi, jsou tvořeny z vícero položek a každá z nich může mít vlastní hodnoty citlivosti a obtížnosti.';
$string['difficulty'] = 'Obtížnost';
$string['discrimination'] = 'Citlivost';
$string['noofitems'] = 'Počet položek';
$string['veryeasy'] = 'Velmi lehká';
$string['easy'] = 'Lehká';
