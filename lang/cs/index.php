...
$string['papersforreview'] = 'Dokumenty k recenzi';
$string['deadline'] = 'Uzávěrka:';
$string['recent'] = 'Naposledy otevřené';
$string['unassigned'] = 'Nezařazené';
$string['unassignedmsg'] = 'Úlohy/dokumenty nezařazené do modulu';
?>