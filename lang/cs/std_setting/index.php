...
$string['createmodifiedangoff'] = 'Nová Angoffova metoda';
$string['createebelmethod'] = 'Nová Ebelova metoda';
$string['editrating'] = 'Upravit hodnocení';
$string['delete'] = 'Odstranit';
$string['modifiedangoff'] = 'Angoffova metoda';
$string['individualrating'] = 'Individuální hodnocení';
$string['currentrating'] = 'Aktuální hodnocení';
$string['grouprating'] = 'Hodnocení skupiny';
