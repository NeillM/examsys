...
$string['hofstee'] = 'Hofstedeova metoda';
$string['integeronly'] = 'celá čísla';
$string['cohort'] = 'Souhrnné % studentů';
$string['correct'] = "Studenti\' známky (%)";
$string['passmark'] = 'Potřebná známka';
$string['distinction'] = 'S vyznamenáním';
$string['minpass'] = 'Min Projde';
$string['maxpass'] = 'Max Projde';
$string['minfail'] = 'Min Neprojde';
$string['maxfail'] = 'Max Neprojde';
$string['cutscore'] = 'Snížit skóre ';
$string['cutpercent'] = 'Snížit %';
