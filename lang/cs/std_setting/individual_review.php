...
$string['modifiedangoffmethod'] = 'Angoffova metoda';
...
$string['step3'] = '<strong>Krok 3: Mřížka S vyznamenáním</strong><br />U každé kategorie (např. Snadná/Zásadní, Snadná/Důležitá, apod.) určete <strong>minimální</strong> počet kandidátů,jež očekáváte, že v dané kategorii, odpoví správně.';
...
$string['notvisible'] = '<strong>Informace:</strong> (kandidátům neviditelná)';
