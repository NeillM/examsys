...
$string['noquestionleadin'] = 'Varování: v hlavičce chybí text úlohy!';
$string['modulenomappings'] = 'Modul Mapování Cílů neumožňuje';
$string['questiontype'] = 'Typ Úlohy';
$string['bloomstaxonomy'] = 'Bloomova Taxonomie';
