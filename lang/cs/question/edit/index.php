...
$string['maximum_size'] = 'Maximální velikost 200 pixelů/bodů.';
...
$string['blankinstructionsddl'] = 'Chcete-li vytvořit prázdné doplňovací pole, napište [blank] a [/blank] kolem voleb, které chcete přidat.<br />Správnou odpověď dejte vždy na místo <strong>první</strong> volby, následovanou distraktory (všechny možnosti budou automaticky náhodně míchány).<br />např. Tyranosaurus <span class="blank-tag">[blank]</span>Rex,Roger,Roderick,Ramsey<span class="blank-tag">[/blank]</span> byl větší než masožravý bipedal &hellip;';
$string['blankinstructionstextboxes'] = 'Chcete-li vytvořit prázdné doplňovací pole, napište [blank] a [/blank] tagy kolem voleb, které chcete přidat.<br />S [blank] tagem za správnou odpovědí jsou správné další alternativy (oddělené čárkou).<br />např. Ve které jsme zemi <span class="blank-tag">[blank]</span>UK,United Kingdom,Britain,Great Britain,GB<span class="blank-tag">[/blank]</span>?';
...
$string['contraindicatedtotally'] = 'zcela kontra-indikováno či téměř úplně';
$string['detrimental'] = 'není užitečné nebo dokonce škodlivé';
$string['useful'] = 'užitečné';
$string['necessary'] = 'absolutně nutné';
$string['contraindicated'] = 'kontra-indikováno';
...
$string['now'] = 'nyní';
$string['never'] = 'nikdy';
$string['validationerror'] = 'Vyplňte, prosím, nejprve všechna povinná pole';
...
$string['cannot'] = 'Nelze komentovat';
