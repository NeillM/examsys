...
$string['message2'] = "<div style=\"text-align:right\"><img src=\"\$logo_path\" width=\"160\" height=\"67\" /></div><p>Dear \$external_title \$external_surname,</p>\n<p>The \$cfg_company has finished reading your comments regarding <strong>\$paper_title</strong> and have finished any amendments. You may now log back into Rogo to review our responses to your comments: <a href=\"\$rogo_url\">\$rogo_url</a></p>\n<p>Any problems with accessing the paper please do not hesitate to contact me. Technical support for Rog&#333; is also available from: <a href=\"mailto:\$support_email\">\$support_email</a></p>\n<p>Kind regards</p>\n<p>\$users_name</p>\n";
