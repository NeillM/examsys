...
requirejs(['jquery'], function ($) {
    $(function () {
        $('#addquestions').submit(function(e) {
            ...
            $.post("do_add_questions.php?paperID=" + paperid + "&display_pos=" + disp + "&module=" + module + "&folder=" + folder
                + "&scrOfY=" + srcofy + "&max_screen=" + max, $('#addquestions').serialize());
