...
//
// Material creator for obj MTL 3d objects
//
...
define(['three'], function (THREE) {
    ...
    return function (baseUrl, options) {
        ...
        this.setMaterials = function (materialsInfo) {
        ...
        this.convert = function (materialsInfo) {
        ...
        this.getIndex = function (materialName) {
        ...
        this.create = function (materialName) {
        ...
        this.createMaterial_ = function (materialName) {
        ...
        this.getTextureParams = function (value, matParams) {
