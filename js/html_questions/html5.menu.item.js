 ...
 * @returns {ROGO.html5.menu_item}
 */
ROGO.html5.menu_item = function(image, help, id) {
  /**
   ...
   * @private
   */
  this.class = ROGO.html5.classes.hotspot.get_class('editmenuitem');
  /**
 ...
 * @returns {Element}
 */
ROGO.html5.menu_item.prototype.create = function() {
 ...
 * @returns {Boolean}
 */
ROGO.html5.menu_item.prototype.toggle = function() {
  if (!this.togglable) {
    return this.active;
  }
  if (this.active === true) {
 ...
 *
 * @returns {Boolean|ROGO.html5.menu_item}
 */
ROGO.html5.menu_item.prototype.set_inactive = function() {
 ...
 * @returns {String}
 */
ROGO.html5.menu_item.prototype.get_name = function() {
  return this.id;
};
 ...
 */
ROGO.html5.menu_item.prototype.find = function(name) {
  if (this.id === name) {
    return this;
  }
  return false;
