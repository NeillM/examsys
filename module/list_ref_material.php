...
<div class="head_title">
  ...
  <div class="breadcrumb"><a href="../index.php"><?php echo $string['home']; ?></a><a href="./index.php?module=<?php echo $modID ?>"><?php echo module_utils::get_moduleid_from_id($modID, $mysqli) ?></a></div>
