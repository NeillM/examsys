...
<head>
  ...
  <title><?php echo page::title('ExamSys: ' . $string['newreferencematerial']); ?></title>
...
<div class="head_title" style="font-size:90%">
  ...
  <div class="breadcrumb"><a href="../index.php"><?php echo $string['home'] ?></a><a href="index.php?module=<?php echo $_GET['module'] ?>"><?php echo module_utils::get_moduleid_from_id($_GET['module'], $mysqli); ?></a><a href="list_ref_material.php?module=<?php echo $_GET['module']; ?>"><?php echo $string['referencematerial']; ?></a></div>
