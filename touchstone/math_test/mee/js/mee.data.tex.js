...
*/
    ...
    */
    ...
    '\\int': { base: 'base_largeop', text: '&#x222B;', offsetlimits: 1 }, 
    '\\intop': { base: 'base_largeop', text: '&#x222B;', limits: 'above', offsetlimits: 1 }, 
    '\\iint': { base: 'base_largeop', text: '&#x222C;', offsetlimits: 1 },
    '\\iiint': { base: 'base_largeop', text: '&#x222D;', offsetlimits: 1 },
    '\\idotsint': { base: 'base_largeop', text: '&idotsint;', limits: '', offsetlimits: 1, mainclass: 'mee_largeop_idotsint' },
    ...
    '\\oint': { base: 'base_largeop', text: '&#x222E;', offsetlimits: 1 },
...
*/
    ...
    '\\over': { all_as_arg01: 1, base: '\\frac' },
    '\\choose': { all_as_arg01: 1, base: '\\frac', lb: '(', rb: ')', bar: 0, size: -1 },
    //#endregion
    ...
    '\\pod': { text: '', lb: '(', rb: ')', next_as_arg0: 1, elemclass: 'mee_pmod', size: -1 },
    //#endregion
    ...
    //#region text stuff
    '\\text': { args: 1, arg0_as_main: 1, simplemain: 1, parseinner: 1 }, //WORKING these actually have 1 argument, but parseinner will eat the first argument
    '\\mbox': { base: '\\text' }, //WORKING
    '\\textrm': { base: '\\text', elemclass: 'mee_font_rm' },
    '\\textit': { base: '\\text', elemclass: 'mee_font_it' },
    '\\textbf': { base: '\\text', elemclass: 'mee_font_bf' },
    ...
    '\\boldsymbol': { base: 'base_font', elemclass: 'mee_font_bold', simplemain: 0 }, 
    '\\pmb': { base: 'base_font', elemclass: 'mee_font_bold', simplemain: 0 },
    //#endregion

    //#region brackets (pairs)
    'base_brackets': { args: 1, arg0_as_main: 1 },
    ...
    //#region matrix
    'base_matrix': { align: 'c', rowclass: 'mee_matrix_row', colclass: 'mee_matrix_col', size: -1, padding: 0.25},
    ...
    '\\substack': { args: 1, arg0_as_array: 1, text: '', nodepth:1 },
    ...
    'base_align' : { nodepth:1, padding: 0.25 },
