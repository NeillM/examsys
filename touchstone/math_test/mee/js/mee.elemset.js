...
},
{
    ...
    sortAlign: function () {
        ...
        if (this.html_elem.hasClass('mee_elemset_empty') || !this.haselements) {
            ...
            if (this.align.width < minwidth) {
                this.html_elem.css('padding-right', (minwidth - this.align.width) - MEE.Data.blankspacesize(this.html_elem) + 'px');
    ...
    Highlight: function () {
        ...
        //hldiv.css('background-image', 'url(' + mee_baseurl + 'images/edit/highlight_' + color + '.png)');
