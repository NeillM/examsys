...
$.Class.extend("MEE.Row",
{
    ...
    toHTML: function(depth, subdepth) {
        ...
        {
            this['html_col' + i] = this['col' + i].toHTML(subdepth);
        ...
        {
            if (this.row + 1 == this.parent.rows && this.eldata.hline && this.cols == 1 && $.trim(this.col0.latex) == "\\hline")
            { // if the last row is nothing but \hline then set the entire thing to have a single border
