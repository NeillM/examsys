  <div id="media-upload-holder">
    <div id="media-upload">
      ...
      <p class="align-centre"><input type="button" name="cancel" value="Cancel" onclick="javascript: history.back();" class="submit" /> <input type="submit" name="submit_media" value="<?php echo $string['next'] ?>" class="submit" /></p>
    </div>
  </div>
