...
<?php
  ...
  $titles = array('Calendar','Clear Guest Accounts' . $added_string,'Clear Old Logs','Clear Orphan Media','Clear Training','Computer Labs','Degrees','Modules','Optimize Tables','SMS Imports','System Information','Trac (issue tracking)','User Management');
  $paths = array('calendar.php#' . date("n"),'clear_guest_users.php','clear_old_logs.php','orphan_media.php','clear_training_module.php','list_labs.php','list_degrees.php','list_modules.php','optimize_tables.php','sms_import_summary.php','system_info.php','https://tiberius.nottingham.ac.uk/trac/touchstone/','../users/search.php');
  $images = array('calendar_icon.png','clear_guest_users.png','clear_logs.png','remove_orphan_icon.png','training.png','computer_lab_48.png','degrees_icon.png','modules_icon.png','optimize_tables_icon.png','sms_import_icon.png','information.png','trac_logo.png','user_accounts_icon.png');
