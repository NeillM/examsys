...
*/
  ...
  echo date('Y-m-d', time()) . 'T' . date('H:i:s') . 'Z';
  echo '</o:LastSaved><o:Pages>1</o:Pages><o:Company>The University of Nottingham</o:Company>';
