...
if ($_GET['modules'] != '') {
  var_dump("SELECT DISTINCT type, value FROM users_metadata, modules WHERE modules.id = users_metadata.idMod AND modules.id IN (" . $_GET['modules'] . ") $sql_session GROUP BY value ORDER BY type, value");
