...
<td style="text-align:left; vertical-align:top" colspan="2">
   ...
   <?php
    ...
    if ($properties->get_paper_type() == '4') {    // OSCE Stations
      ...
      $texteditorplugin->get_textarea('osce_marking_guidance', 'osce_marking_guidance', htmlspecialchars($properties->get_paper_postscript(), ENT_NOQUOTES), plugins\plugins_texteditor::type_standard, "height:230px;");
      echo "</td></tr>";
...
<tr><td><?php $texteditorplugin->get_textarea('paper_prologue', 'paper_prologue', htmlspecialchars($properties->get_paper_prologue(), ENT_NOQUOTES), plugins\plugins_texteditor::type_standard, "height:537px"); ?></td></tr>
</table>
...
<tr><td><?php $texteditorplugin->get_textarea('paper_postscript', 'paper_postscript', htmlspecialchars($properties->get_paper_postscript(), ENT_NOQUOTES), plugins\plugins_texteditor::type_standard, "height:537px"); ?></td></tr>
</table>
...
<table id="rubric" class="tabsection" style="display: none">
  ...
  <tr><td><?php $texteditorplugin->get_textarea('rubric_text', 'rubric_text', htmlspecialchars($properties->get_rubric(), ENT_NOQUOTES), plugins\plugins_texteditor::type_standard, "height:537px"); ?></td></tr>
</table>
