...
<div class="head_title">
  ...
  <div class="breadcrumb"><a href="../index.php"><?php echo $string['home'] ?></a><a href="../module/index.php?module=<?php echo $modID ?>"><?php echo module_utils::get_moduleid_from_id($modID, $mysqli) ?></a><a href="sessions_list.php?module=<?php echo $modID ?>"><?php echo $string['manageobjectives'] ?></a></div>
