...
if (isset($_POST['submit'])) {
  ...
  if ($_FILES['txtfile']['name'] != 'none' and $_FILES['txtfile']['name'] != '') {
    if (!move_uploaded_file($_FILES['txtfile']['tmp_name'], $cfg_tmpdir . $userObject->GetUserID() . '_load_objectives.txt'))  {
      ...
      $lines = file($cfg_tmpdir . $userObject->GetUserID() . '_load_objectives.txt');
  ...
  unlink($cfg_tmpdir . $userObject->GetUserID() . '_load_objectives.txt');
