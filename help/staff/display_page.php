...
if ($_GET['id'] > 1) {
  ...
  if ($userObject->has_role('SysAdmin')) {
    echo '<tr><td colspan="2" style="padding-right:20px; text-align:right; color:#316AC5">' . $configObject->get('protocol') . $_SERVER['HTTP_HOST'] . $configObject->get('cfg_root_path') . '/help/staff/index.php?id=' . $_GET['id'] . '</tr>';
  }
  echo "</table>\n";
}
?>
