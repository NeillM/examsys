...
if (mb_substr((string) $min_value, 0, 3) == 'var' or mb_substr((string) $min_value, 0, 3) == 'ans') {
...
if (mb_substr((string) $max_value, 0, 3) == 'var' or mb_substr((string) $max_value, 0, 3) == 'ans') {
