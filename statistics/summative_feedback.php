...
<div class="head_title">
  ...
  <div class="page_title"><?php echo $string['summativeexamfeedback'] ?>: <span style="font-weight:normal"><?php echo $_GET['calyear']; ?>/<?php echo (mb_substr($_GET['calyear'], 2, 2) + 1); ?></span></div>
</div>
