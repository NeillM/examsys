...
$result = $mysqli->prepare("SELECT schools.id, school.code, school, faculty,code, name FFROM schools, faculty WHERE schools.facultyID = faculty.id AND school != 'Training' AND schools.deleted IS NULL AND faculty.deleted IS NULL ORDER BY name, school");
$result->execute();
