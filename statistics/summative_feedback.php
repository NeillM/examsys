...
<head>
  ...
  <title><?php echo page::title('ExamSys: ' . $string['summativeexamfeedback']); ?></title>
...
<div class="head_title">
  ...
  <div class="breadcrumb"><a href="../index.php"><?php echo $string['home'] ?></a><a href="../admin/index.php"><?php echo $string['administrativetools'] ?></a><a href="../statistics/index.php"><?php echo $string['statistics'] ?></a></div>
  <div class="page_title"><?php echo $string['summativeexamfeedback'] ?>: <span style="font-weight:normal"><?php echo $_GET['calyear']; ?>/<?php echo (mb_substr((string) $_GET['calyear'], 2, 2) + 1); ?></span></div>
</div>
